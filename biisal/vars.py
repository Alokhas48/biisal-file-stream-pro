...
class Var(object):
    ...
    API_HASH = str(getenv('API_HASH', '42e71744fb1829f43010bd6003224daf'))
    BOT_TOKEN = str(getenv('BOT_TOKEN' , '7291653888:AAERGT7DxqWdl44AGX2pCpzii7jUyc-amLg'))
    name = str(getenv('name', 'Shajaioaobot'))
    SLEEP_THRESHOLD = int(getenv('SLEEP_THRESHOLD', '60'))
    WORKERS = int(getenv('WORKERS', '4'))
    BIN_CHANNEL = int(getenv('BIN_CHANNEL', '-1002230610165'))
    NEW_USER_LOG = int(getenv('NEW_USER_LOG', '-1002230610165'))
    ...
    DATABASE_URL = str(getenv('DATABASE_URL', 'mongodb+srv://FILES:FILES@cluster0.j83kdbu.mongodb.net/?retryWrites=true&w=majority'))
